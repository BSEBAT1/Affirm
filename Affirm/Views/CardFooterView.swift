...
// Seperate the card footer and the header views since the pod is built this way. Just text with a shadow.
...
class CardFooterView: UIView {
    ...
    private func initialize(title: String?, subtitle: String?) {
        ...
        if let subtitle = subtitle, !subtitle.isEmpty {
            attributedText.append(NSMutableAttributedString(string: subtitle+" stars",
